...
case FLAG_VISITED_NEWBARK_TOWN:
        return FlagGet(MAPSEC_NEW_BARK_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_CHERRYGROVE_CITY:
        return FlagGet(MAPSEC_CHERRYGROVE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_VIOLET_CITY:
        return FlagGet(MAPSEC_VIOLET_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_AZALEA_TOWN:
        return FlagGet(MAPSEC_AZALEA_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_GOLDENROD_CITY:
        return FlagGet(MAPSEC_GOLDENROD_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_ECRUTEAK_CITY:
        return FlagGet(MAPSEC_ECRUTEAK_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_OLIVINE_CITY:
        return FlagGet(MAPSEC_OLIVINE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_CIANWOOD_CITY:
        return FlagGet(MAPSEC_CIANWOOD_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_SAFARI_ZONE_GATE:
        return FlagGet(MAPSEC_SAFARI_ZONE_GATE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_MAHOGANY_TOWN:
        return FlagGet(MAPSEC_MAHOGANY_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_LAKE_OF_RAGE:
        return FlagGet(MAPSEC_LAKE_OF_RAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_BLACKTHORN_CITY:
        return FlagGet(MAPSEC_BLACKTHORN_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_INDIGO_PLATEAU:
        return FlagGet(MAPSEC_INDIGO_PLATEAU) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
case FLAG_VISITED_MT_SILVER:
        return FlagGet(MAPSEC_MT_SILVER) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    default:
